...
namespace MoneyTransformer.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Message,Subject,Email,Phonenumber,Name")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Message,Subject,Email,Phonenumber,Name")] Contactu contactu)
        {
            if (id != contactu.Id)
            {
                return NotFound();
