...
namespace MoneyTransformer.Controllers
{
    public class HomesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text1,Text2,Text3,Image1path,Image2path,Image3path,Logopath,Email,Phonenumber,Image4path,Facebooklink,Instagramlink")] Home home)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Text1,Text2,Text3,Image1path,Image2path,Image3path,Logopath,Email,Phonenumber,Image4path,Facebooklink,Instagramlink")] Home home)
        {
            if (id != home.Id)
            {
                return NotFound();
