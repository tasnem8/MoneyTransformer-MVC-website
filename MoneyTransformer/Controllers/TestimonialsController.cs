...
namespace MoneyTransformer.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,Status,TestimonialDate,UserId")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Text,Status,TestimonialDate,UserId")] Testimonial testimonial)
        {
